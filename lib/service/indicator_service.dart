...
Future<List<IndicatorVoLite>> fetchIndicatorList() async {
  ...
  return (responseJson as List).map((p) => IndicatorVoLite.fromJson(p)).toList();
}

Future<IndicatorVo> fetchIndicator(int id) async {
  final response = await http.get(
